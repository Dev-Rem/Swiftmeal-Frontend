      ...
      <div className="aboutus-text-container">
        <div style={{ padding: 50 }}>
          ...
          <Text fontSize="lg" color="white">
            ...
            browse through a diverse range of restaurants, explore their menus,
          ...
          <Text fontSize="lg" color="white">
            ...
            deliveries in real-time, and make secure online payments. Swiftmeal
            strives to enhance the overall food ordering process, making it more
            efficient, enjoyable, and accessible to everyone.
          </Text>
        </div>
        <div style={{ padding: 50 }}>
          <div className="banner-heading">
          ...
          <Text fontSize="lg" color="white">
            By connecting hungry individuals with their favorite local eateries,
            Swiftmeal facilitates a dynamic and vibrant food culture. The
            platform promotes local businesses and empowers restaurants to reach
          ...
          <Text fontSize="lg" color="white">
            Whether it's a quick lunch break, a cozy dinner at home, or catering
            for a special event, Swiftmeal is the go-to destination for
            satisfying cravings, supporting local businesses, and embracing the
            diverse world of gastronomy.
          </Text>
        </div>
      </div>
    </div>
